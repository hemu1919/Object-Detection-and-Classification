...
function convnet_coarse = convtrain_coarse()
%CONVIMG Summary of this function goes here
%   Detailed explanation goes here
 
     imdsTrain = imageDatastore('.\train_coarse','IncludeSubfolders', true, 'FileExtensions', '.png', 'LabelSource', 'foldernames');
       layers = [imageInputLayer([32 32 3], 'DataAugmentation', 'randfliplr', 'Normalization', 'zerocenter');
         ...
         convnet_coarse = trainNetwork(imdsTrain, layers, options);  
         save('convnet_coarse.mat','convnet_coarse');
